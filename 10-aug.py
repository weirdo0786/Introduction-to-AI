...
# fill value is 7 means int type that's why it is int type


print('working of np.eye(2)')
d = np.eye(2)
print(d)
print(d.dtype)

# practice this - How to print [1.00 0.00],[0.00 1.00]
print('how to print .2 decimal')
d = np.eye(2)
...
# practice that why b taking the values of a without linking of a.
# Home-work solution
